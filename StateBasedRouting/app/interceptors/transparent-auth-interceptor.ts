...
class TransparentAuthInterceptor
{
	 ...
	 */
	private accessTokenRequest: ng.IPromise<IAccessTokenResult>;
	 ...
	 */
	private getAccessTokenService: () => IAccessTokenService;
	 ...
	 */
	private getAccessTokenAsync(realm: string): ng.IPromise<IAccessTokenResult> {
